                        ...
                        <div className="bg-[#FB7E10] rounded-3xl p-8 md:p-10 text-white relative shadow-[0_20px_40px_rgba(251,126,16,0.3)] overflow-hidden">
                           ...
                           <div className="relative z-10 space-y-8">
                                ...
                                <div className="pt-8 border-t border-white/20">
                                    ...
                                    <a href="tel:07494024653" className="w-full flex items-center justify-center gap-3 bg-white text-[#FB7E10] py-5 rounded-xl font-black uppercase tracking-widest text-sm md:text-base hover:bg-slate-900 hover:text-white transition-all shadow-xl active:scale-95">
                                        <Phone size={20} />
                                        Call Now
                                    </a>
                                </div>
