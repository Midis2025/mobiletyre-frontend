      ...
      >
        ...
        <div className="flex lg:hidden justify-center items-center scale-90 sm:scale-100">
          <a
            ...
            className="flex items-center gap-2 bg-black text-[#FB7E10] px-4 py-2.5 rounded-full font-black text-[11px] tracking-widest shadow-lg hover:scale-105 transition-all whitespace-nowrap"
          >
        ...
        <div className="flex justify-end items-center gap-4">
          <div className="hidden lg:block">
            <a
              href="tel:02071013856"
              className="flex items-center gap-2 bg-black text-[#FB7E10] px-6 py-3 rounded-full font-black text-[13px] tracking-widest shadow-lg hover:scale-105 active:scale-95 transition-all whitespace-nowrap"
            >
              <Phone size={14} fill="currentColor" />
              <span>0207 101 3856</span>
            </a>
